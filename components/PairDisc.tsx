  ...
  return (
    <div className="w-full py-24 bg-[#05060A] text-[var(--blanc-pur)] overflow-hidden border-t border-[rgba(255,255,255,0.1)]">
      <div className="max-w-[1280px] mx-auto px-6 md:px-16">
        ...
        {/* 3D Model Stage Container - Deep Dark Slate Stage (Perfect Fit with Complete Header & Headroom) */}
        <div className="w-full h-[640px] md:h-[760px] bg-[#05060A] relative overflow-hidden flex items-center justify-center p-6 border-none outline-none">
